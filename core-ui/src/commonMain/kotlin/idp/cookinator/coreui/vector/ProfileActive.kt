...
val Icons.ProfileActive: ImageVector
    get() {
        if (_ProfileActive != null) {
            return _ProfileActive!!
        }
        _ProfileActive = ImageVector.Builder(
            name = "ProfileActive",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(
                ...
                moveTo(16.224f, 6.787f)
                curveTo(16.224f, 9.21f, 14.26f, 11.174f, 11.837f, 11.174f)
                horizontalLineTo(11.806f)
                curveTo(9.392f, 11.165f, 7.442f, 9.202f, 7.45f, 6.787f)
                curveTo(7.45f, 4.365f, 9.415f, 2.4f, 11.837f, 2.4f)
                curveTo(14.26f, 2.4f, 16.224f, 4.365f, 16.224f, 6.787f)
                close()
                moveTo(5f, 18.787f)
                curveTo(5f, 21.087f, 8.153f, 21.662f, 11.844f, 21.662f)
                curveTo(15.556f, 21.662f, 18.689f, 21.066f, 18.689f, 18.766f)
                curveTo(18.689f, 16.465f, 15.536f, 14.362f, 11.844f, 14.362f)
                curveTo(8.133f, 14.362f, 5f, 16.486f, 5f, 18.787f)
                close()
            }
            path(
...
private var _ProfileActive: ImageVector? = null
